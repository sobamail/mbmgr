...
MODULES = [
    ...
    (f"{dirname(__file__)}/../base/model/Base.mjs", "https://sobamail.com/schema/base/v1"),
    (f"{dirname(__file__)}/../base/model/MailboxManagerEvent.mjs", "https://sobamail.com/schema/mailboxmanager/v1"),
    (f"{dirname(__file__)}/../base/model/UserManagerEvent.mjs", "https://sobamail.com/schema/usermanager/v1"),
]
