...
import {
    DeleteRow,
    NotFoundError,
} from "https://sobamail.com/schema/base/v1?sha224=NsUpJcBHKy1buy4HDMcnx6wbVylytXwDm9QyoA";
/* clang-format off */
import {
    InitializeFolders,
    InitializeMessages,
...
export default class MailboxManager {
    ...
    process(message, meta) {
        ...
        if (meta.type == "message" && meta.location == "limbo") {
    ...
    on_email(message) {
        ...
        soba.log.info(`Message: ${message.uuid} was delivered to inbox 1`);
        ...
        soba.log.info(`Message: ${message.uuid} was delivered to inbox 2`);
    }
